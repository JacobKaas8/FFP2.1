...
<div class="container-fluid overlay bg-light bg-opacity-90">
    <div class="row">
        <div class="col-12">
            <div class="text-center position-absolute top-20 start-50 translate-middle-x">
                ...
                <a href="kategori.php"><button class="btn border border-3 border-primary rounded-4 link-primary fs-1 fw-semibold px-5 py-2">&nbsp;&nbsp;&nbsp;&nbsp;Start&nbsp;&nbsp;&nbsp;&nbsp;</button></a>
            </div>
        </div>
        <div class="col-12">
